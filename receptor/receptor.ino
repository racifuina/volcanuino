...
void loop() {
    ...
    if (vw_get_message(buf, &buflen)) { //Recepción del Buffer de comunicación
        if(buf[0]=='1'){ //si el buffer es igual a '1' se alerta a los pobladores y se activa el protocolo de seguridad
            alertPeople();
...
/*
void alertPeople();
Función que indica que la lectura de algún anillo de seguridad muestra que hay actividad volcanica, activa todos los sistemas de seguridad y alarma. 
*/
